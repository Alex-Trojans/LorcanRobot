...
from LorcanRobot import pbot as app 
from LorcanRobot import arq
from LorcanRobot.services.keyboard import Ikb
from LorcanRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from LorcanRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from LorcanRobot.services.types import InlineQueryResultCachedDocument
from LorcanRobot.modules.info import get_chat_info, get_user_info
from LorcanRobot.utils.functions import test_speedtest
from LorcanRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Lorcanbot"),
        InlineKeyboardButton(
