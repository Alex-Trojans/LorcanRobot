...
from LorcanRobot.modules.helper_funcs.decorators import Lorcancmd, Lorcanmsg
from LorcanRobot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from LorcanRobot.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel
from LorcanRobot.modules.language import gs

@Lorcancmd(command="antichannelmode", group=100)
...
@Lorcanmsg(Filters.chat_type.groups, group=110)
