...
from LorcanRobot.mongo import db
from LorcanRobot.services.telethonbasics import is_admin
from LorcanRobot.events import register
from LorcanRobot.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from LorcanRobot import telethn as tbot, MONGO_DB_URI, BOT_ID
